    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="applyvisitor.php">Apply Visitors</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="qrcodeverify.php">QR Code Verify</a>
                </li>
            </ul>
