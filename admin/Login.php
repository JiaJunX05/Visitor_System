...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $adminController->Login($name, $password);
            ...
            <div class="col">
                ...
                <form action="login.php" method="post">
                    ...
                    <div class="text-center mt-4">
                        <p class="text-secondary" style="font-size: 20px;">Don't have an account? <a href="register.php" style="text-decoration: none; color: red;">Sign Up</a></p>
                    </div>
                </form>    
            </div>
        </div>
